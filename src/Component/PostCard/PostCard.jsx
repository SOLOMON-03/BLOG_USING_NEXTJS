    ...
    <div className="flex flex-col p-2 ">
      <div className="flex bg-white rounded-lg">
        <div className=" relative w-[300px] h-[300px] z-[1] object-cover">
          ...
          >
            <Image src="/post1.jpg" alt="" fill className=" rounded-tl-lg rounded-bl-lg" />
          </Suspense>
        </div>
      ...
      <div className="p-2 flex flex-col gap-2">
        ...
        <p className="w-[90%] text-sm text-justify">{post.body}</p>
        <Link href={`/blog/${post.id}`} className="underline text-[#a19df1]">
          Read More..
        </Link>
      </div>
    </div>
